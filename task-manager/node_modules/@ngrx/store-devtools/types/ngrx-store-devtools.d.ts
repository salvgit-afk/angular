...
import { ActionReducer, Action, ActionCreator, ActionsSubject, StateObservable, ReducerObservable, ScannedActionsSubject } from '@ngrx/store';
 ...
 */
interface ActionCreatorDescriptor {
    name: string;
    func: ActionCreator;
    args: string[];
}
...
declare class DevtoolsExtension {
    ...
    private readonly actionCreatorDescriptors?;
